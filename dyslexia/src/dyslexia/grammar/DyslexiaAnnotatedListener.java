 ...
 * @author Gaming
 */
public class DyslexiaAnnotatedListener extends DyslexiaBaseListener {
    // GUI Components
    ...
    public DyslexiaAnnotatedListener(PnlConsole pnlConsole){
    ...
    public void exitVariableDeclarator(DyslexiaParser.VariableDeclaratorContext ctx) { 
        if ( mainMethodExecuting ) {
            ...
            if ( arrayValue != null ) setArrayValue(ctx, arrayValue);
                ...
                //System.out.println("VariableName: " + variableName + " Symbol: " + symbol.toString());
